...
import {
  Zap, Type, FileText, Download,
  ChevronRight, Play, Star, Check, ArrowRight, ChevronDown, ChevronLeft, X
} from 'lucide-react'
...
const testimonials = [
  {
    ...
    role: 'Podcast Host',
    avatar: 'MT',
    text: 'ShortForge turned my 2-hour podcast into 30 clips in under 15 minutes. My YouTube Shorts channel went from 0 to 8k subs in a month.',
    stars: 5,
  },
  {
    name: 'Priya K.',
...
const faqs = [
  { q: 'How many clips can I generate?', a: 'Depends on your plan. Starter gets 100 clips/month, Creator gets 500, and Agency gets unlimited.' },
  { q: 'Do I own the clips?', a: 'Yes. 100% of the generated content is yours. We don\'t claim any rights.' },
  { q: 'Can I upload to YouTube automatically?', a: 'Yes — connect your YouTube account in the Channels section and publish with one click or schedule.' },
  { q: 'Which languages are supported?', a: 'We currently support 25+ languages for transcription and captioning. More added regularly.' },
]

const pricingPlans = [
  { name: 'Starter', price: 19, features: ['10 uploads/month', '100 clips', 'AI captions', 'Download all clips'] },
  { name: 'Creator', price: 49, features: ['50 uploads/month', '500 clips', 'YouTube publishing', 'Priority processing', 'Custom captions'], popular: true },
  { name: 'Agency', price: 149, features: ['Unlimited uploads', 'Unlimited clips', 'Multiple channels', 'Team members', 'API access', 'Dedicated support'] },
]
...
export function Homepage() {
  ...
  const leftImg = sliderImages[(currentIndex - 1 + sliderImages.length) % sliderImages.length]
    ...
    <div className="overflow-hidden">
        ...
        <div className="absolute inset-0 flex pointer-events-none">
          ...
          <div className="w-[65%] h-full relative overflow-hidden bg-[#15171e]">
            ...
            <div 
              ...
              style={{ 
                backgroundImage: 'repeating-radial-gradient(circle at 10% 10%, transparent, transparent 80px, #ffffff 80px, #ffffff 81px)' 
              }} 
            />
          ...
          <div className="w-[35%] h-full bg-[#EF5350] relative overflow-hidden">
            ...
            <div className="absolute top-24 left-1/2 -translate-x-1/2 flex gap-3">
              {[1,2,3,4,5,6,7].map(i => <div key={i} className="w-1.5 h-1.5 rounded-full bg-white/80" />)}
            </div>
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-12 pt-20 pb-12 lg:py-0">
          ...
          <div className="w-full lg:w-[30%] pl-0 lg:pl-10 xl:pl-12 flex flex-col items-start text-left">
            ...
            >
              <Link 
                to="/register" 
                className="bg-[#EF5350] hover:bg-[#C62828] text-[#111] px-8 pt-5 pb-8 font-semibold text-sm italic tracking-widest transition-colors flex flex-col items-center min-w-[160px] relative group shadow-lg"
              >
                START FREE
                <div className="absolute bottom-2 flex flex-col items-center -space-y-2 group-hover:translate-y-1 transition-transform">
                  <ChevronDown size={16} className="text-[#111]" />
                  <ChevronDown size={16} className="text-[#111]/70" />
                  <ChevronDown size={16} className="text-[#111]/40" />
                </div>
              </Link>
              <button className="text-white hover:text-[#EF5350] font-semibold text-sm italic tracking-widest transition-colors flex flex-col items-center pt-5 relative group h-full">
                WATCH DEMO
                <div className="absolute top-[42px] flex flex-col items-center -space-y-2 group-hover:translate-y-1 transition-transform">
          ...
          >
            ...
            <div className="absolute left-[20%] lg:left-[25%] right-[20%] lg:right-[10%] h-[75%] bg-gray-900 shadow-2xl z-20 overflow-hidden border border-white/10">
                ...
                <div className="absolute top-6 right-6 font-bold text-lg italic tracking-widest text-[#1A1A1A] text-right leading-tight bg-white/70 backdrop-blur-sm p-2 pointer-events-none z-30">
                  <span className="text-[#EF5350]">S</span>HORT<br/>FORGE
                </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <motion.div {...fadeUp} className="mb-16">
              <p className="text-sm text-[#EF5350] font-bold tracking-widest uppercase mb-4">Workflow</p>
              <h2 className="text-4xl sm:text-5xl font-bebas text-[#1A1A1A] leading-none mb-6">How It Works</h2>
              <p className="text-[#616161]">From full-length video to viral clips in four simple steps.</p>
            </motion.div>
            ...
            <div className="relative border-l-2 border-[#FFCDD2]/50 ml-4 pl-8 pb-4 space-y-12">
              {howItWorksSteps.map((step, i) => (
                ...
                >
                  {/* Timeline Node */}
                  <div className={`absolute -left-[43px] top-0 w-5 h-5 rounded-full border-4 transition-colors ${activeStep === i ? 'border-[#EF5350] bg-white' : 'border-[#FFCDD2] bg-[#FFF5F5] group-hover:border-[#EF9090]'}`} />
                  
                  {/* Step Content */}
                  <h3 className={`text-xl font-bold mb-3 transition-colors ${activeStep === i ? 'text-[#1A1A1A]' : 'text-[#9E9E9E] group-hover:text-[#616161]'}`}>
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="sticky top-32 w-full aspect-square rounded-2xl bg-[#FFFFFF] shadow-2xl border border-[#FFCDD2] overflow-hidden flex items-center justify-center p-8">
              ...
              <div 
                ...
                style={{ 
                  backgroundImage: 'repeating-radial-gradient(circle at center, #1A1A1A, #1A1A1A 1px, transparent 1px, transparent 20px)' 
                }} 
              />
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            <h2 className="text-5xl sm:text-6xl font-bebas text-[#1A1A1A] leading-none mb-4">
              Everything you need to <br/><span className="text-[#EF5350]">go viral</span>
            </h2>
            <p className="text-[#616161] max-w-xl mx-auto">One platform handles the entire workflow from long-form content to polished short clips.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-[#1A1A1A] mb-2 relative z-10">{f.title}</h3>
                <p className="text-sm text-[#9E9E9E] leading-relaxed line-clamp-2 relative z-10">{f.desc}</p>
      ...
      <section className="py-20 px-4 bg-[#FFF5F5] border-y border-[#FFCDD2] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <motion.div {...fadeUp} className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bebas text-[#1A1A1A] leading-none mb-2">Real results, minimal effort</h2>
            <p className="text-[#616161] text-lg">From one input to everywhere, in minutes.</p>
          </motion.div>
            ...
            {stats.map((s, i) => (
              <React.Fragment key={s.label}>
                ...
                >
                  ...
                  <p className="text-sm text-[#616161] font-medium">{s.label}</p>
                </motion.div>
                {/* Divider */}
                {i < stats.length - 1 && (
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-20 bg-[#FFFFFF] p-8 md:p-12 border border-[#FFCDD2] rounded-2xl">
            <div className="w-full md:w-2/3 pl-6 border-l-4 border-[#EF5350]">
              <p className="text-2xl md:text-3xl font-bold text-[#1A1A1A] italic leading-snug">
                "ShortForge turned my 2-hour podcast into 30 viral clips in under 15 minutes. My YouTube Shorts channel went from 0 to 8k subs in a month."
              </p>
            </div>
            ...
            {testimonials.map((t, i) => (
              <motion.div
                ...
                className={`bg-[#FFFFFF] p-8 min-h-[240px] flex flex-col justify-between transition-all ${
                  i === 1 ? 'border-2 border-[#EF5350]/40 shadow-lg scale-105 z-10' : 'border border-[#FFCDD2] hover:border-[#EF9090]'
                }`}
              >
                <div>
                  <div className="flex items-center gap-1 mb-6">
                    {Array.from({ length: t.stars }).map((_, j) => (
                      <Star key={j} size={14} className="fill-[#EF5350] text-[#EF5350]" />
                    ))}
                  </div>
                  <p className="text-[13px] text-[#616161] italic leading-relaxed mb-8">"{t.text}"</p>
                </div>
      ...
      <section className="py-24 px-4 bg-[#FFF5F5] border-y border-[#FFCDD2]">
        <div className="max-w-5xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-10">
            <h2 className="text-4xl sm:text-5xl font-bebas text-[#1A1A1A] mb-4">Simple, transparent pricing</h2>
            <p className="text-[#616161]">Start free, scale when you're ready.</p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16">
          <div className="w-full md:w-1/3">
            <motion.div {...fadeUp} className="sticky top-32">
              <h2 className="text-4xl sm:text-5xl font-bebas text-[#1A1A1A] leading-none mb-6">Have questions? We've got answers.</h2>
              <p className="text-[#616161] leading-relaxed mb-8">Everything you need to know about the product and billing. Can't find the answer you're looking for?</p>
              <Link to="/contact" className="inline-flex items-center justify-center px-6 py-3 bg-[#EF5350] text-white font-semibold shadow-md hover:bg-[#C62828] transition-colors">
                Contact support
              </Link>
            </motion.div>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="text-[#EF5350] flex-shrink-0 ml-4">
                      {activeFaq === i ? <X size={20} /> : <Zap size={20} className="rotate-90 opacity-0 absolute" />} {/* using Zap placeholder or just +/- icons if they existed, wait I can use standard + and - or just an arrow. Since I don't have plus/minus imported from lucide-react, I will use ChevronRight/ChevronDown */}
      ...
      <section className="py-32 px-4 bg-[#FFFFFF] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            {...fadeUp}
          >
            <h2 className="text-5xl sm:text-7xl font-bebas text-[#1A1A1A] mb-6 tracking-tight">Start creating in minutes</h2>
            <p className="text-[#616161] text-lg mb-12 max-w-2xl mx-auto">No credit card. No commitment. Just results. Join thousands of creators turning long videos into viral moments.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button
                className="w-full sm:w-auto inline-flex justify-center items-center px-10 py-4 border-2 border-[#EF5350] text-[#EF5350] font-semibold hover:bg-[#FFF5F5] transition-colors"
              >
                Watch Demo
              </button>
            </div>
