      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden border-b border-[#FFCDD2]">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="w-full md:w-2/3 mb-16">
            ...
            >
              Excido exists because great content shouldn't be locked behind a video editing degree.
            </motion.p>
          </div>
          ...
          >
            <p className="text-xl text-[#1A1A1A] max-w-2xl font-medium leading-relaxed italic border-l-4 border-[#EF5350] pl-6">
              "We built Excido because manually clipping content was taking hours every week. We wanted a tool that didn't just add captions, but actually found the best moments and prepared them for publishing instantly."
            </p>
          </motion.div>
        </div>
      </section>
