            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={label}>
                  <Link
                    to={to}
                    className="text-sm text-[#9E9E9E] hover:text-[#616161] transition-colors"
                  >
                    {label}
                  </Link>
                </li>
        ...
        <div className="border-t border-[#FFCDD2] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex items-center gap-4 text-xs text-[#9E9E9E]">
              ...
              <Link to="/terms" className="hover:text-[#616161]">
                Terms of Service
              </Link>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.734-8.84L1.254 2.25h7.064l4.259 5.632L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a
              href="#"
